  ...
  return (
    <div id="app-container" className="min-h-screen bg-[#f4f6f8] flex justify-center items-start overflow-y-auto font-sans antialiased text-slate-800 py-0 md:py-10">
      ...
      <div 
        ...
        className="w-full max-w-xl bg-[#fafcfd] md:rounded-3xl md:shadow-lg border border-[#eef2f6] relative overflow-hidden flex flex-col justify-between transition-all min-h-screen md:min-h-[850px]"
      >
